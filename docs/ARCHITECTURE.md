...
* **Governance Plane**: The Trust Gateway evaluates request attributes against `policy.toml` (`crates/trust-policy`, `policy-sdk`). If required, human approval (WebAuthn / Telegram OTP) is triggered.
