...
- **Server 1 (Public Domain)**: HTTP Webhooks, Edge Leaf Node. Zero private keys, zero sovereign databases.
...
|---|---|---|---|---|---|
| `public.v1.ingress.>` | Public Gateway | Agent Runtime | Yes | No (Transit only) | `adapters/transport-nats` |
