...
pub struct GatewayState {
    ...
    pub tool_registry: Option<Arc<router::ToolRegistry>>,
    ...
    /// Pluggable transport drivers for dynamic MCP server connectivity.
    pub transport_registry: Option<Arc<crate::transport::TransportRegistry>>,
    /// Pluggable app registry for dynamic MCP server connectivity.
    pub app_registry: Option<Arc<crate::app_registry::AppRegistry>>,
