...
/// Formal Transaction Execution Lifecycle States
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize, schemars::JsonSchema)]
#[serde(rename_all = "snake_case")]
...
/// Explicit operation metadata for governed tool execution.
#[derive(Debug, Clone, Serialize, Deserialize, schemars::JsonSchema)]
pub struct OperationAttributes {
    /// Operation classification: "read_only", "financial_mutation", "data_egress", "destructive"
    pub operation_kind: String,
    /// Target resource identifier, if any
    pub resource: Option<String>,
    /// Monetary amount involved for threshold evaluation, if any
    pub amount: Option<Money>,
    /// Recipient/beneficiary, if any
