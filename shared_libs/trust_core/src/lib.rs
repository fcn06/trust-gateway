...
// Edition separation: port traits and DTOs for CE/Pro boundary
pub mod ports;
pub mod ports_dto;

// Flexible MCP connectivity: transport abstraction, manifest-driven discovery, OAuth token broker
